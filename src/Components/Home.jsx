      ...
      <div className="containerform">
        <section className="formAll">
          <div className="tittle-header">
            ...
            <p className="text-P">
              Para mayor información acerca de tu orden debes iniciar sesión o
              registrarte
            </p>
          </div>
          <Row>
            <Col xs={12} md={6}>
              <Form ClassName="number-order">
                <Form.Group controlId="formBasic">
                  <h4 id="title-one">Consulta el estado de tu compra</h4>
                  <p>
                  ...
                  <Form.Text className="text-muted">
                    Si no conoces tu número de orden, solicítalo al 600 600 4020
                    a nuestros ejecutivos Sodimac.
                  </Form.Text>
                </Form.Group>
                <br />
                <br />
