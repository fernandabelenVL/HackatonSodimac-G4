      ...
      <div>
        ...
        <Table bordered hover>
          ...
          <tbody>
            <tr>
              {/* SKU */}
              <td className="grey-bg">363261-X</td>
              {/* Imagen */}
              <td className="ima-box">
                <img
                  className="product-ima"
                  alt="Producto"
                  src="https://sodimac.scene7.com/is/image/SodimacCL/363261X_01?$producto495$&id=t_Vm93&fmt=jpg&fit=constrain,1&wid=493&hei=493"
                />
              </td>
              {/* Producto */}
              <td>Combo Piscina 427x84 cm + bomba 530 gl Bestway</td>
              {/* Unidades */}
              <td>1</td>
              {/* Precio */}
              <td>$129.990</td>
              {/* Boleta */}
              <td>
                <a href="/singleorder">Ver Detalles</a>
              </td>
            </tr>
            {/* <tr>
